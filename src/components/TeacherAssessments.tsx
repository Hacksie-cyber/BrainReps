                ...
                return (
                  ...
                  >
                    ...
                    <div className={cn(
                      ...
                      quiz.isHidden ? "from-amber-400 to-amber-500" : theme.gradientBar
                    )} />
                    ...
                    <div className="relative z-10 p-7 flex-1 flex flex-col">
                      ...
                      <div className="space-y-4 mb-6">
                        <h3 className={cn("text-xl font-bold font-display text-slate-900 dark:text-white transition-colors tracking-tight leading-tight", theme.titleHover)}>{quiz.title}</h3>
                        
                        <div className="flex flex-col gap-2.5">
                          <div className="flex items-center gap-2 group/educator cursor-help">
                            <div className={cn(
                              "w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[7px] font-black text-slate-500 dark:text-slate-400 transition-colors uppercase border border-slate-200/50 dark:border-slate-700/50",
                          ...
                          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                            ...
                            <div className={cn("text-[10px] font-black uppercase tracking-widest px-2.5 py-0.5 rounded border", theme.subtleBadge)}>
                            ...
                            {quiz.deadline && (
                              <div className={cn(
                                ...
                                new Date(quiz.deadline) < new Date() ? "bg-red-50 dark:bg-red-900/20 text-red-500 dark:text-red-400 border border-red-100 dark:border-red-900/50 animate-pulse" : theme.subtleBadge
                              )}>
                    ...
                    <div className="relative z-10 px-7 py-5 bg-slate-50/30 dark:bg-slate-800/30 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between transition-all">
                      <div className={cn("flex items-center gap-2 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest transition-colors", theme.titleHover)}>
