            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <span className="ms-3 text-[8px] font-black uppercase tracking-tighter text-slate-500">Global Access</span>
                </label>
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <div className={cn(
                                ...
                                student.isBanned ? "bg-red-50 text-red-400" : (isSelected ? "bg-indigo-600 text-white" : "bg-slate-100 text-slate-400 group-hover:bg-slate-200")
                              )}>
                              ...
                              <div>
                                <div className="flex items-center gap-2">
                                  ...
                                  {student.isBanned && (
                                    <span className="text-[7px] font-black uppercase text-red-500 bg-red-50 px-1 rounded border border-red-100">Restricted</span>
                                  )}
                                </div>
