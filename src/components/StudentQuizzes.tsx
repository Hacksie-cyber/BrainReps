              ...
              filteredQuizzes.map((quiz, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className={cn(
                      "group relative flex flex-col bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] hover:-translate-y-1.5 transition-all duration-300 overflow-hidden",
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      <h3 className={cn("text-xl font-bold font-display text-slate-900 dark:text-slate-100 transition-colors tracking-tight leading-tight mb-2", theme.titleHover)}>
                        {quiz.title}
                      </h3>
                      ...
                      <div className="flex flex-col gap-2.5 mb-5">
                        <div className="flex items-center gap-2 group/educator cursor-help" title={`Curriculum designed by ${quiz.teacherName}`}>
                           <div className={cn(
                             "w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[8px] font-black text-slate-50 dark:text-slate-400 transition-colors uppercase border border-slate-200/50 dark:border-slate-700/50",
                      ...
                      {topAchievers[quiz.id] && (
                         <div className={cn("mb-6 p-4 rounded-xl border flex flex-col gap-2 transition-colors", theme.topAchieverBg, theme.topAchieverBorder)}>
