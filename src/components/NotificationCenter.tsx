        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed lg:absolute left-1/2 lg:left-auto lg:right-0 -translate-x-1/2 lg:translate-x-0 top-[70px] lg:top-full mt-0 lg:mt-2 w-[calc(100vw-2rem)] sm:w-80 md:w-96 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 z-50 overflow-hidden"
            >
